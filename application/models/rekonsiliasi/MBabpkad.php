...
class MBabpkad extends CI_Model {
    public function ambildata($tglcetak,$bulan,$tahun) {
        $mysqli = $this->db->conn_id; 
 
        $statment = $mysqli->prepare("CALL spRptRekonBPKAD(?, ?, ?)");
        $statment->bind_param('sss', $tglcetak,$bulan,$tahun);  
    ...
    public function formInsert() {
        ...
        <div class="card">
            <div class="card-body">
                <form action="' . site_url('rekonsiliasi/babpkad/cetak') . '" class="form-row" method="post">
