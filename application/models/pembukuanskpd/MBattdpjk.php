...
class MBattdpjk extends CI_Model {
    public function cetaktotal($tahun, $bulan, $kdrekening)
    {
        $query = $this->db
            ...
            ->where("c.kdrekening LIKE CONCAT('{$kdrekening}', '%')", null, false)
            ->get('trx_sptpd a');
    ...
    public function formInsert() {
        ...
        <div class="card">
            <div class="card-body">
                <form action="' . site_url('pembukuanskpd/beritaacarattdpjk/cetak') . '" class="form-row" method="post" target="printFrame">
