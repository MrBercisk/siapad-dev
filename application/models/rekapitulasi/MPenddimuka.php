...
class MPenddimuka extends CI_Model {
    public function ambildata($bulan, $tahun) {
        $mysqli = $this->db->conn_id; 
 
        $statment = $mysqli->prepare("CALL spRptPendapatanDimuka(?, ?)");
    ...
    public function formInsert() {
        ...
        <div class="card">
            <div class="card-body">
                <form action="' . site_url('rekapitulasi/PendDimuka/cetak') . '" class="form-row" method="post">
