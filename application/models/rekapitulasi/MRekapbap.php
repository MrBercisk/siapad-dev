...
class MRekapbap extends CI_Model {
    public function ambildata($kdrekening, $tahun) {
        $mysqli = $this->db->conn_id; 
 
        $statment = $mysqli->prepare("CALL spRptPendapatanBPPRD(?, ?)");
    ...
    public function formInsert() {
        ...
        <div class="card">
            <div class="card-body">
                <form action="' . site_url('rekapitulasi/RekapBap/cetak') . '" class="form-row" method="post">
