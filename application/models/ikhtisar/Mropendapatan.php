...
class Mropendapatan extends CI_Model {
    ...
    public function formInsert() {
        ...
        ->from('mst_rekening')
        ->where('mst_rekening.islrauptd', 1)
        ->get()
        ->result();
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="ttd">Pembuat Dokumen:</label>
                              <select id="tanda_tangan" name="pembuat" class="form-control select2" data-placeholder="Pilih Pembuat Dokumen" style="width: 100%;">
                                      '.$opsittd.'
                              </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="ttd">Rekening:</label>
                              <select id="tanda_tangan" name="rekening" class="form-control select2" data-placeholder="Pilih Rekening" style="width: 100%;">
                                      '.$opsirek.'
                              </select>
                        </div>
                    </div>
