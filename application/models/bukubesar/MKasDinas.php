...
class MKasDinas extends CI_Model {
    ...
    public function formInsert() {
        ...
        <div class="card">
            <div class="card-body">
                <form id="reportForm" action="' . site_url('bukubesar/KasDinas/cetak') . '" class="form-row" method="post" onsubmit="printForm(); return false;">
        ...
        xhr.onload = function () {
            ...
            if (xhr.status === 200) {
                if (printWindow && !printWindow.closed) {
                    ...
                    printWindow.document.open();
                    printWindow.document.write("<html><head><title>SIAPAD - Kas Per Dinas</title>");
