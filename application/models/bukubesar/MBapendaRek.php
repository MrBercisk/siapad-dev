...
class MBapendaRek extends CI_Model {
    public function ambildata($kdrekening, $tahun) {
        $mysqli = $this->db->conn_id; 
 
        $statment = $mysqli->prepare("CALL spRptBBPPDPerRekThn(?, ?)");
    ...
    public function formInsert() {
       ...
       /*  $opsiwp = '<option value="">Pilih Wajib Pajak</option>'; */
        ...
        <div class="card">
            <div class="card-body">
                <form id="reportForm"  action="' . site_url('bukubesar/bapendarek/cetak') . '" class="form-row" method="post" onsubmit="printForm(); return false;">
                        ...
                        <label class="form-check-label" for="ttd">Penandatangan</label>
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="pokok">Jumlah</label>
                                </div>
                            </div>
                    </div>
        ...
        xhr.onload = function () {
            ...
            if (xhr.status === 200) {
                if (printWindow && !printWindow.closed) {
                    ...
                    printWindow.document.open();
                    printWindow.document.write("<html><head><title>SIAPAD - Bapenda Tahunan Per Rekening</title>");
