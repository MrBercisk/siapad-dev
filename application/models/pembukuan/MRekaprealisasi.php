...
class MRekaprealisasi extends CI_Model {

    public function ambildata($tahun) {
        $mysqli = $this->db->conn_id; 
 
        $statment = $mysqli->prepare("CALL spRptLRAPerUPTDRekapMasaPajak(?)");
    ...
    public function formInsert() {
        ...
        <div class="card">
            <div class="card-body">
                <form action="' . site_url('pembukuan/rekaprealisasi/cetak') . '" class="form-row" method="post" target="printFrame">
