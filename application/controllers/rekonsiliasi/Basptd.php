...
class Basptd extends CI_Controller {
	public function __construct() {
        parent::__construct();
		$this->load->model('rekonsiliasi/MBasptd');
    }
	...
	{	
		...
		$data = [
			...
			'title' => $setpage->title,
			'link' => $setpage->link,
			'forminsert' =>  implode($this->MBasptd->formInsert())
	
		];
		$this->load->view('rekonsiliasi/basptd',$data);
	}
