...
class BapendaOp extends CI_Controller {
	public function __construct() {
        parent::__construct();
		$this->load->model('bukubesar/MBapendaOp');
    }
	...
	{	
		...
		$data = [
			...
			'title' => $setpage->title,
			'link' => $setpage->link,
			'forminsert' =>  implode($this->MBapendaOp->formInsert())
	
		];
		$this->load->view('bukubesar/bapendaop',$data);
	}
