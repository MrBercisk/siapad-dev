...
class PiutangLama extends CI_Controller {
	public function __construct() {
        parent::__construct();
		$this->load->model('pembukuanskpd/Mpiutanglama');
    }
	...
	{	
		...
		$data = [
			...
			'title' => $setpage->title,
			'link' => $setpage->link,
			'forminsert' =>  implode($this->Mpiutanglama->formInsert())
	
		];
		$this->load->view('pembukuanskpd/lappiutanglama',$data);
	}
	...
	$tablenya = $this->Mpiutanglama->ambildata($bulan, $tahun, $iduptd);
	/* echo '<pre>';
	var_dump($tablenya);
	echo '</pre>';
	die(); */
	...
	$this->load->view('pembukuanskpd/printpiutanglama', $data );
