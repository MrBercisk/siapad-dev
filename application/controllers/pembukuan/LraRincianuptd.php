...
class LraRincianuptd extends CI_Controller {
	public function __construct() {
        parent::__construct();
		$this->load->model('pembukuan/MLrarincianuptd');
    }
	...
	{	
		...
		$data['forminsert'] = implode($this->MLrarincianuptd->formInsert());
		$this->load->view('pembukuan/lrarinciuptd',$data);
	}
	public function cetak() {
		...
		$tablenya = $this->MLrarincianuptd->ambildata($tahun);
